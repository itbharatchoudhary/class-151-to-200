                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 flex flex-col justify-between">
                                                <div>
                                                    <h2
                                                        className="font-light leading-tight mb-3 cursor-pointer"
                                                        style={{
                                                            fontFamily: "'Cormorant Garamond', serif",
                                                ...
                                                <div className="flex items-center justify-between flex-wrap gap-4">
                                                    ...
                                                    <button
                                                        onClick={() => handleRemoveFromCart({ productId: _id, variantId })}
                        ...
                        <div className="w-full lg:w-[35%] lg:sticky lg:top-28">
                            ...
                            >
                                ...
                                <div className="flex justify-between items-baseline mb-8">
                                    ...
                                    <span className="text-base uppercase tracking-[0.18em] font-medium" style={{ color: tokens.onSurface }}>{formatCurrency(subtotal)}</span>
                                </div>
                                <button
